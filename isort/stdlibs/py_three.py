"""
File contains the standard library of python3

If in any minor the standard library changes, a new list should be
created and the names adjusted
"""

standard_library_3 = ['AL', 'BaseHTTPServer', 'Bastion', 'CGIHTTPServer', 'Carbon', 'ColorPicker',
