...
* [isort 5.0.0 changelog](../changelog.rst)
* [isort 5 release document](../major_releases/introducing_isort_5.md)
...
See: [float-to-top](../configuration/options.md#float-to-top)
...
[config files documentation page](../configuration/config_files.md).
...
In isort 5, you can still get this behavior by moving your extra modules from the `known_standard_library` setting to [`extra_standard_library`](../configuration/options.md#extra-standard-library).
